...
export const webRepository: TaskRepository = {
  ...
  getWorkbookState: async () => readJson('workbookState', null),
  saveWorkbookState: async (v) => writeJson('workbookState', v),
  ...
  getCustomPrograms: async () => readJson('customPrograms', null),
  saveCustomPrograms: async (v) => writeJson('customPrograms', v),
  ...
  getCountdownState: async () => readJson('countdownState', null),
  saveCountdownState: async (v) => writeJson('countdownState', v),
};
